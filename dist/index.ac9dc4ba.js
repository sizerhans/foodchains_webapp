...
})({"bcgVo":[function(require,module,exports) {
...
// code in index.js from: https://developer.mozilla.org/en-US/docs/Web/API/Media_Capture_and_Streams_API/Taking_still_photos
var _indexJs = require("./index.js");
(0, _vue.createApp)((0, _appVueDefault.default)).mount("#app");

},{"vue":"gzxs9","./App.vue":"fYNyc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./index.css":"irmnC","./index.js":"8lqZg"}],"gzxs9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
let script;
let initialize = ()=>{
    script = require("72ad61a68796a6a3");
    if (script.__esModule) script = script.default;
    script.render = require("b99233b09e8d48cf").render;
    require("2c096e7c1d2d0849").default(script);
    script.__scopeId = "data-v-e0bd40";
    script.__file = "C:\\Users\\wrsiz\\Documents\\University\\THCI\\foodchains\\src\\App.vue";
};
initialize();
if (module.hot) {
    script.__hmrId = "e0bd40-hmr";
    module.hot.accept(()=>{
        setTimeout(()=>{
            initialize();
            if (!__VUE_HMR_RUNTIME__.createRecord("e0bd40-hmr", script)) __VUE_HMR_RUNTIME__.reload("e0bd40-hmr", script);
        }, 0);
    });
}
exports.default = script;

},{"2c096e7c1d2d0849":"h0MjM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","72ad61a68796a6a3":"iiJmB","b99233b09e8d48cf":"evi43"}],"h0MjM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let NOOP = ()=>{};
exports.default = (script)=>{};
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _buttonsVue = require("./../app/Buttons.vue");
var _buttonsVueDefault = parcelHelpers.interopDefault(_buttonsVue);
var _plantsJson = require("./json/plants.json");
var _plantsJsonDefault = parcelHelpers.interopDefault(_plantsJson);
var _animalsJson = require("./json/animals.json");
var _animalsJsonDefault = parcelHelpers.interopDefault(_animalsJson);
exports.default = {
    components: {
        Buttons: (0, _buttonsVueDefault.default)
    },
    data () {
        return {
            plantData: (0, _plantsJsonDefault.default),
            animalData: (0, _animalsJsonDefault.default),
            labels: []
        };
    },
    methods: {}
...
},{"./../app/Buttons.vue":"9my3j","./json/plants.json":"ftbhb","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./json/animals.json":"bpMGC"}],"9my3j":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let script;
let initialize = ()=>{
    script = require("cec1a6b69650a1c3");
    if (script.__esModule) script = script.default;
    script.render = require("4cde2b4f8e85c06").render;
    require("b5a39cb3b2bdae7a").default(script);
    script.__scopeId = "data-v-4a730d";
    script.__file = "C:\\Users\\wrsiz\\Documents\\University\\THCI\\foodchains\\app\\Buttons.vue";
};
initialize();
if (module.hot) {
    script.__hmrId = "4a730d-hmr";
    module.hot.accept(()=>{
        setTimeout(()=>{
            initialize();
            if (!__VUE_HMR_RUNTIME__.createRecord("4a730d-hmr", script)) __VUE_HMR_RUNTIME__.reload("4a730d-hmr", script);
        }, 0);
    });
}
exports.default = script;

},{"b5a39cb3b2bdae7a":"lX4aG","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","cec1a6b69650a1c3":"hWBz4","4cde2b4f8e85c06":"imCKb"}],"lX4aG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let NOOP = ()=>{};
exports.default = (script)=>{};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hWBz4":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
exports.default = {
    ...
    methods: {
        handleClick (type) {
            ...
            if (type == "plant") {
                ...
                this.firstTier = false;
            } else console.log(this.objectToUse[this.index - 1][0].noNextTier);
            indexChecker = this.index;
            if (indexChecker != 1) indexChecker -= 1;
            ...
            if (!this.objectToUse[indexChecker][0].noNextTier) {
                ...
                for(let y = 0; y < this.currentButtons.length; y++){
                    for(let x = 0; x < this.objectToUse[this.index].length; x++)if (this.objectToUse[this.index][x].label != this.currentButtons[y]) this.currentButtons.splice(y);
                }
                //adds new labels to the buttons array
                for(let i = 0; i < this.objectToUse[this.index].length; i++)this.currentButtons.push(this.objectToUse[this.index][i].label);
                this.index += 1;
        ...
        handleBack () {
            ...
            for(let x = 0; x < this.currentButtons.length; x++)this.currentButtons.splice(x);
            this.index = 1;
            this.firstTier = true;
        }
    }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"imCKb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "render", ()=>render);
var _vue = require("vue");
function render(_ctx, _cache, $props, $setup, $data, $options) {
    return (0, _vue.openBlock)(), (0, _vue.createElementBlock)("div", null, [
        $data.firstTier ? ((0, _vue.openBlock)(), (0, _vue.createElementBlock)("button", {
            key: 0,
            onClick: _cache[0] || (_cache[0] = ($event)=>$options.handleClick("plant"))
        }, (0, _vue.toDisplayString)($props.plantJson.cat[0].label), 1 /* TEXT */ )) : (0, _vue.createCommentVNode)("v-if", true),
        $data.firstTier ? ((0, _vue.openBlock)(), (0, _vue.createElementBlock)("button", {
            key: 1,
            onClick: _cache[1] || (_cache[1] = ($event)=>$options.handleClick("animal"))
        }, (0, _vue.toDisplayString)($props.animalJson.cat[0].label), 1 /* TEXT */ )) : (0, _vue.createCommentVNode)("v-if", true),
        ((0, _vue.openBlock)(true), (0, _vue.createElementBlock)((0, _vue.Fragment), null, (0, _vue.renderList)($data.currentButtons, (label)=>{
            return (0, _vue.openBlock)(), (0, _vue.createElementBlock)("button", {
                id: "btn-group",
                onClick: _cache[2] || (_cache[2] = ($event)=>$options.handleClick())
            }, (0, _vue.toDisplayString)(label), 1 /* TEXT */ );
        }), 256 /* UNKEYED_FRAGMENT */ )),
        !$data.firstTier ? ((0, _vue.openBlock)(), (0, _vue.createElementBlock)("button", {
            key: 2,
            id: "btn-back",
            onClick: _cache[3] || (_cache[3] = ($event)=>$options.handleBack())
        }, "Back")) : (0, _vue.createCommentVNode)("v-if", true)
    ]);
}
if (module.hot) module.hot.accept(()=>{
    __VUE_HMR_RUNTIME__.rerender("4a730d-hmr", render);
});

},{"vue":"gzxs9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ftbhb":[function(require,module,exports) {
module.exports = JSON.parse('{"1":[{"label":"Round","noNextTier":false},{"label":"Needle"}],"2":[{"label":"green","noNextTier":true},{"label":"brown"},{"label":"red"}],"cat":[{"label":"Plant","noNextTier":false}]}');

},{}],"bpMGC":[function(require,module,exports) {
module.exports = JSON.parse('{"1":[{"label":"Insect","noNextTier":false},{"label":"Bird"},{"label":"Mammal"}],"2":[{"label":"limbless","noNextTier":false},{"label":"Two Legs"},{"label":"Four Legs"},{"label":"Four Plus"}],"3":[{"label":"brown","noNextTier":true},{"label":"green"},{"label":"red"}],"cat":[{"label":"Animal","noNextTier":false}]}');
...
parcelHelpers.export(exports, "render", ()=>render);
var _vue = require("vue");
const _hoisted_1 = /*#__PURE__*/ (0, _vue.createStaticVNode)('<div class="camera"><video id="video">Video stream not available.</video><button id="startbutton">Take photo</button></div><canvas id="canvas"></canvas><div class="output"><img id="photo" alt="The screen capture will appear in this box."></div><h2>Describe your Photo</h2>', 4);
function render(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_Buttons = (0, _vue.resolveComponent)("Buttons");
    return (0, _vue.openBlock)(), (0, _vue.createElementBlock)((0, _vue.Fragment), null, [
        (0, _vue.createCommentVNode)("html for the camera defined in index.js"),
        _hoisted_1,
        (0, _vue.createCommentVNode)("dynamic Button component passes Json files"),
        (0, _vue.createVNode)(_component_Buttons, {
            plantJson: $data.plantData,
            animalJson: $data.animalData
        }, null, 8 /* PROPS */ , [
            "plantJson",
            "animalJson"
        ])
...
if (module.hot) module.hot.accept(()=>{
    __VUE_HMR_RUNTIME__.rerender("e0bd40-hmr", render);
});

},{"vue":"gzxs9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"irmnC":[function() {},{}],"8lqZg":[function(require,module,exports) {
(()=>{
    ...
    function identifyButton(type) {
        ...
        if (type == "plant") group.innerHTML = "<h3>Does your Plant have</h3><button onclick=\"identifyButton('plant')\">Square Leaves</button> <button onclick=\"identifyButton('animal')\">Elipse leaves</button>";
    }
...
},{}]},["bcgVo","aR1JP"], "aR1JP", "parcelRequireb525")
